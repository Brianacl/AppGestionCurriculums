...
namespace AppGestionCurriculums.ViewModels.EvaCurriculoHerramientas
{
    public class FicVmEvaCurriculoHerramientasList : FicViewModelBase
    {
        ...
        public Eva_curriculo_conocimientos FicConocimiento;
        ...
        public Eva_curriculo_conocimientos DatosConocimiento
        {
            get
            {
                return FicConocimiento;
            }
            set
            {
                if (value != null)
                {
                    FicConocimiento = value;
                    RaisePropertyChanged();
                }
            }//ITEM SELECCIONADO
        }//Fin de SelectedItem
        ...
        public async override void OnAppearing(object context)
        {
            try
            {
                var conocimiento = context as Eva_curriculo_conocimientos;

                if(conocimiento != null )
                {
                    System.Diagnostics.Debug.WriteLine("Trae conocimiento");
                    DatosConocimiento = conocimiento;
                }

                SourceHerramientas.Clear();

                var source_local_inv = await IFicSrvCurriculoHerramientas.FicMetGetListHerramientas(DatosConocimiento);
