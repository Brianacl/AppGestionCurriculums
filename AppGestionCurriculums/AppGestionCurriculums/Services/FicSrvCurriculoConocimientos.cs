...
namespace AppGestionCurriculums.Services
{
    public class FicSrvCurriculoConocimientos : IFicSrvCurriculoConocimientos
    {
        ...
        public async Task<IEnumerable<Eva_curriculo_conocimientos>> FicMetGetListConocimientos()
        {
            return await(from eva_curriculo_conocimientos in LoDBContext.eva_curriculo_conocimientos select eva_curriculo_conocimientos).AsNoTracking().ToListAsync();
        }
